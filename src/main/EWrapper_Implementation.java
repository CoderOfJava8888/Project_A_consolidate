...
//! [ewrapperimpl]
public class EWrapper_Implementation implements EWrapper {
    //! [ewrapperimpl]

    public double lastTick;
    public double overallUnrealizedPNL;
    ...
    //! [socket_init]
    public EWrapper_Implementation() {
...
//        System.out.println("UpdateAccountValue. Key: " + key + ", Value: " + value + ", Currency: " + currency + ", AccountName: " + accountName);
    ...
    Map<String, List<Double>> HashMap_UpdatePortfolio = new HashMap<>();
    ...
    public void updatePortfolio(Contract contract, double position,
        ...
        String contractSymbol = contract.symbol();  ///         String contractSymbol = contract.m_symbol;
        HashMap_UpdatePortfolio.put(contractSymbol, Arrays.asList(position, marketPrice, marketValue, averageCost, unrealizedPNL, realizedPNL));
    }
    //! [updateportfolio]

    public Map<String, List<Double>> getHashMap_UpdatePortfolio() {
        return HashMap_UpdatePortfolio;
    }

    public void setHashMap_UpdatePortfolio(Map<String, List<Double>> HashMap_UpdatePortfolio) {
        this.HashMap_UpdatePortfolio = HashMap_UpdatePortfolio;
    }
...
//        System.out.println("CommissionReport. [" + commissionReport.execId() + "] - [" + commissionReport.commission() + "] [" + commissionReport.currency() + "] RPNL [" + commissionReport.realizedPNL() + "]");
    ...
    public void position(String account, Contract contract, double pos, double avgCost) {
        ...
        positions.put(contract.symbol(), pos);
    ...
    public void setPositions(HashMap<String, Double> positions) {
...
//        System.out.println("Position. " + account + " - Symbol: " + contract.symbol() + ", SecType: " + contract.secType() + ", Currency: " + contract.currency() + ", Position: " + pos + ", Avg cost: " + avgCost);
//
//        String s = Double.toString(pos);
//        String c = contract.symbol() + s;
//        SD.add(c);
//    }
//    //! [position]
//
...
//    }
//
//    public void setSD(ArrayList<String> SD) {
//        this.SD = SD;
//    }
...
//! [pnl]
    ...
    public double getoverallUnrealizedPNL() {
        return overallUnrealizedPNL;
    }

    public void setoverallUnrealizedPNL(double overallUnrealizedPNL) {
        this.overallUnrealizedPNL = overallUnrealizedPNL;
    }
